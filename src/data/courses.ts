...
export const courses: Course[] = [
  ...
  },
  {
    ...
    title: 'トイ・プログラミングコース',
    shortTitle: 'トイプロ',
    description: '触れる・作る・遊ぶを通じて、プログラミングの基本概念を体感的に学習します。',
    image: '/images/courses/toyprogramming-course.jpg',
    imageAlt: 'トイ・プログラミングコース',
    targetAge: '年長～小学3年生',
    duration: '45分/回',
    price: '月4回 8,000円',
    features: [
  ...
  },
  {
    ...
    shortTitle: 'Unity',
    description: 'プロ仕様のゲームエンジン「Unity」を使って、本格的な3Dゲームを制作します。',
